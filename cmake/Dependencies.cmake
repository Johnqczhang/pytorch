...
if(USE_GLOO)
  ...
  elseif(NOT CMAKE_SIZEOF_VOID_P EQUAL 8)
    ...
    find_package(Gloo)
    if(Gloo_FOUND)
      message(STATUS "Found Gloo  (include: ${Gloo_INCLUDE_DIR}, library: ${Gloo_LIBRARY})")
      include_directories(${Gloo_INCLUDE_DIR})
    else()
      message(WARNING "Gloo not found. Not compiling with Gloo. Suppress this warning with -DUSE_GLOO=OFF")
      caffe2_update_option(USE_GLOO OFF)
    endif()
